...
# Load the CSV files
trait_data = pd.read_csv('/Users/nico/Desktop/Google_Drive/MAGMA/PCA_ICA_April2024/IC_loci_GWAS_Catalog/all_combined_traits_without_imaging_and_repetition.csv')
